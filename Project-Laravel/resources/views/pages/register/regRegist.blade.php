        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Join With Us!</h4></div>
                ...
                @csrf
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="first_name" type="text" class="form-control" name="namaAwal" autofocus>
                    </div>
                    <div class="form-group col-6">
                      <label for="last_name">Last Name</label>
                      <input id="last_name" type="text" class="form-control" name="namaAkhir">
                    </div>
                  </div>
